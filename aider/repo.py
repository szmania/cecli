...
class GitRepo:
    ...
    async def commit(self, fnames=None, context=None, message=None, aider_edits=False, coder=None):
        ...
        - aider_edits=True: Changes were generated by Aider-CE (LLM).
        ...
        Flags:
        - --attribute-author: Modify Author name to "User Name (aider-ce)".
        - --attribute-committer: Modify Committer name to "User Name (aider-ce)".
        - --attribute-co-authored-by: Add
          "Co-authored-by: aider-ce (<model>)" trailer to commit message.
        ...
        2. When aider_edits = False (User Changes):
           ...
           - Committer name IS modified by default (implicit True, as Aider-CE runs `git commit`).
           - EXCEPTION: If --attribute-committer is EXPLICITLY False, the name is NOT modified.

        Resulting Scenarios:
        - Standard AI edit (defaults): Co-authored-by=False -> Author=You(aider-ce),
          Committer=You(aider-ce)
        ...
        - AI edit with Co-authored-by + Explicit Author: Co-authored-by=True,
          --attribute-author -> Author=You(aider-ce), Committer=You, Trailer added
        - User commit (defaults): aider_edits=False -> Author=You, Committer=You(aider-ce)
        ...
        if aider_edits and attribute_co_authored_by:
            ...
            commit_message_trailer = f"\n\nCo-authored-by: aider-ce ({model_name})"

        # Determine if author/committer names should be modified
        # Author modification applies only to aider-ce edits.
        ...
        # (it's not an aider-ce edit with co-authored-by OR committer was explicitly set).
        ...
        if prefix_commit_message:
            commit_message = "aider-ce: " + commit_message
        ...
        committer_name = f"{original_user_name} (aider-ce)"
