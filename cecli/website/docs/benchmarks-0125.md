...
cecli's existing
[lazy coding benchmark](https://cecli.dev/docs/unified-diffs.html).
...
- It gets worse benchmark scores when using the [unified diffs](https://cecli.dev/docs/unified-diffs.html) code editing format.
...
- [Code editing benchmarks for OpenAI's "1106" models](https://cecli.dev/docs/benchmarks-1106.html).
- [cecli's lazy coding benchmark](https://cecli.dev/docs/unified-diffs.html).
