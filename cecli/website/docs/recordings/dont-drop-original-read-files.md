...
description: Follow along as cecli is modified to preserve read-only files specified at launch when using the /drop command. cecli does this implementation and adds test coverage.
---
...
- 0:20 Let's explain the needed change to cecli.
...
- 2:19 Let's ask cecli to add tests for this.
